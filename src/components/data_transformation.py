...
class DataTransformation:
    ...
    def get_transformer_object(self):
        try:
            ...
            logging.info("Numerical columns scaling and imputations done.")
            logging.info("Categorical columns encoding and imputations done.")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Data loaded successfully as df in data_transformation component")
